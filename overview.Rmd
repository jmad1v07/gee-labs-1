...
Each of the labs relate to a stage in the geospatial data analysis workflow outlined above. Thematically, the labs will focus on geospatial data analysis focusing on issues in urban areas primarily using data from the Perth region.  

...
You are going to use `trainingData` to train a classification and regression tree (CART) algorithm to predict a pixel's land cover type based on its spectral reflectance values. 
